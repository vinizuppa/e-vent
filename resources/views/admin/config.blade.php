<x-app-layout>
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2">
        ...
        <div class="col">
            <a href="{{ route('users.index', ['group' => 'organizador']) }}" class="btn btn-outline-danger p-3 w-100">
                <h5>Organizadores</h5>
                <i class="fas fa-user-tie fa-5x"></i>
            </a>
        </div>
        <div class="col">
            <a href="{{ route('users.create') }}" class="btn btn-outline-danger p-3 w-100">
                <h5>Novo organizador</h5>
