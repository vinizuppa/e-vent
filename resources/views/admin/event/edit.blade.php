<x-app-layout>
    ...
    <form action="{{ route('events.update', [$event->id]) }}" method="post" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input id="registration_fee" type="text" class="form-control @error('registration_fee') is-invalid @enderror" name="registration_fee" value="{{ old('registration_fee') ?? $event->registration_fee }}" autocomplete="registration_fee">
