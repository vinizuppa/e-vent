<x-app-layout>
    <x-slot name="title">{{ $group != '' ? $group : 'Todos os usuários' }}</x-slot>
    <x-slot name="cardHeader">
        <div class="row">
            <div class="col">
                <a href="{{ route('users.index') }}" class="btn btn-primary">Todos</a>
                <a href="{{ route('users.index', ['group' => 'participant']) }}" class="btn btn-success">
                    <i class="fas fa-user"></i>
                    Participantes
                </a>
                <a href="{{ route('users.index', ['group' => 'organizer']) }}" class="btn btn-warning">
