        ...
        <div class="card-body">
            ...
            <form action="{{ route('events.store') }}" method="post" enctype="multipart/form-data" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input id="registration_fee" type="number" min="0" max="1000" class="form-control @error('registration_fee') is-invalid @enderror" name="registration_fee" value="{{ old('registration_fee') ?? '0' }}">
